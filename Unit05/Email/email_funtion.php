<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->SetFrom("huyennu.1907@gmail.com", "Ngoc.Son.Nguyen"); // Thông tin người gửi
        $mail->AddReplyTo("huyennu.1907@gmail.com","Ngoc.Son.Nguyen");// Ấn định email sẽ nhận khi người dùng reply lại.
